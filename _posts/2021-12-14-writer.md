...
date: 2021-12-14 00:00:00 +0530
categories: [hackthebox, linux]
tags: [sqli, sqli file read,  apache wsgi, smb, ssrf, rce, postfix, invoke command with apt config, command injection]     # TAG names should always be lowercase
image: /assets/img/posts/writer/writer_banner.png
---


![](/assets/img/posts/writer/writer_banner.png)
...
![](/assets/img/posts/writer/sqli-auth.png)
...
![](/assets/img/posts/writer/file-upload-settings.png)

And Second in `/dashboard/stories/add`

![](/assets/img/posts/writer/file-upload-stories.png.png)

adding a stories also have url option in place of file upload.

![](/assets/img/posts/writer/stories-url.png)
...
![](/assets/img/posts/writer/static-index.png)
...
![](/assets/img/posts/writer/ssrf-in-storie.png)
...
![](/assets/img/posts/writer/union-sqli.png)
...
![](/assets/img/posts/writer/sqli-file-read.png)
...
![](/assets/img/posts/writer/apache-site-enable.png)
...
![](/assets/img/posts/writer/dev-urls-py.png)

![](/assets/img/posts/writer/dev-views-py.png)

if we append reverse shell in `views.py` it could give us shell.

![](/assets/img/posts/writer/views-with-shell.png)

And request `http://127.0.0.1:8080/#.jpg` with ssrf we found in `/dashboard/stories/add`

![](/assets/img/posts/writer/web-shell.png)
...
![](/assets/img/posts/writer/django-dbshell.png)
...
![](/assets/img/posts/writer/add-command-in-scr.png)
...
![](/assets/img/posts/writer/send-nc-mail.png)
...
![](/assets/img/posts/writer/john-manage.png)
...
![](/assets/img/posts/writer/rooted.png)
...
![](/assets/img/posts/writer/img-up-os-injection.png)
...
![](/assets/img/posts/writer/os-injection-test.png)
...
![](/assets/img/posts/writer/command-injection.png)
