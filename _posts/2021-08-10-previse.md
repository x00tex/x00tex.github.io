...
tags: [command injection, binary path injection]     # TAG names should always be lowercase
image: /assets/img/posts/previse/previse_banner.png
---


![](/assets/img/posts/previse/previse_banner.png)
...
![](/assets/img/posts/previse/files-php.png)

We can create new account from `/accounts.php` with POST request.

![](/assets/img/posts/previse/account-create.png)
...
* `logs.php` has a command injection bug in line 19-20
  ...
  ![](/assets/img/posts/previse/log-source.png)
...
![](/assets/img/posts/previse/blind-ci.png)
...
![](/assets/img/posts/previse/john-the-hash.png)
...
![](/assets/img/posts/previse/date-path-miss.png)
...
![](/assets/img/posts/previse/rooted.png)