...
![](/assets/img/posts/schooled/version-compare2.png)
...
![](/assets/img/posts/schooled/manager-privesc3.png)
...
- [ ] Forget to take screenshot <!--![](/assets/img/posts/schooled/edit-roles.png)-->
...
![](/assets/img/posts/schooled/admin-rce2.png)
...
found exploit from [gtfobins](https://gtfobins.github.io/gtfobins/pkg/), *this is same as `sudo snap` on armageddon box.
