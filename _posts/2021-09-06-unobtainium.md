...
tags: [reversing, electron application, deb package, lodash 4.17.4, prototype pollution, google-cloudstorage-commands 0.0.1, command injection, kubernetes]     # TAG names should always be lowercase
image: /assets/img/posts/unobtainium/unobtainium_banner.png
---


![](/assets/img/posts/unobtainium/unobtainium_banner.png)
...
![](/assets/img/posts/unobtainium/port-80.png)
...
![](/assets/img/posts/unobtainium/deb-control-info.png)
...
![](/assets/img/posts/unobtainium/reverse-deb.png)
...
![](/assets/img/posts/unobtainium/exec-app.png)
...
![](/assets/img/posts/unobtainium/asar-extract.png)

only interesting file found on application source code is `todo,js`

![](/assets/img/posts/unobtainium/todo-js.png)
...
![](/assets/img/posts/unobtainium/app-todo.png)
...
![](/assets/img/posts/unobtainium/no-file-error.png)
...
![](/assets/img/posts/unobtainium/get-index-file.png)
...
* There are 2 user, in this application, admin user password is random, so not possible to get it.
  ...
  ![](/assets/img/posts/unobtainium/two-users.png)

* There is a another endpoint `/upload`

  ![](/assets/img/posts/unobtainium/upload-endpoint.png)
...
![](/assets/img/posts/unobtainium/outdated-deps.png)
...
1. [`lodash: 4.17.4`](https://www.npmjs.com/package/lodash/v/4.17.4) is vulnerable for [Prototype Pollution](https://portswigger.net/daily-swig/prototype-pollution-the-dangerous-and-underrated-vulnerability-impacting-javascript-applications) Vulnerability, **[CVE-2018-16487](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-16487):** [snyk Vulnerability DB](https://snyk.io/vuln/SNYK-JS-LODASH-73638), in lodash <4.17.11 functions `merge`, `mergeWith`, and `defaultsDeep` can be tricked into adding or modifying properties of `Object.prototype`.
  ...
  * And we can verify this from `index.js` file that put method when sending message it uses `_.merge`
    ...
    ![](/assets/img/posts/unobtainium/put-message.png)
...
* We can use Prototype Pollution Vulnerability to enable `canUpload` for user `felamos`
  ...
  ![](/assets/img/posts/unobtainium/send-proto.png)
...
2. [`google-cloudstorage-commands : 0.0.1`](https://www.npmjs.com/package/google-cloudstorage-commands) **CVE-2020-28436:** [snyk Vulnerability DB](https://snyk.io/vuln/SNYK-JS-GOOGLECLOUDSTORAGECOMMANDS-1050431), Affected versions of this package are vulnerable to Command Injection from `upload` function. If we check [source code](https://github.com/samradical/google-cloudstorage-commands/blob/e69c931c4363be266489b26a1766760c9fce08d2/index.js#L7-L16) of this library, it is using `exec` function to upload file.
  ...
  * And we can verify this from `index.js` file that `/upload` is using `upload()` function.
    ...
    ![](/assets/img/posts/unobtainium/upload-ci.png)
...
* now we can Use `/upload` endpoint with user "`felamos`" credentials to inject system command into `upload()` function from `filename` parameter.
  ...
  ![](/assets/img/posts/unobtainium/exec-cmd.png)
...
![](/assets/img/posts/unobtainium/rev-shell.png)
...
![](/assets/img/posts/unobtainium/cron-in-kube.png)
...
![](/assets/img/posts/unobtainium/Kubernetes.png)
...
![](/assets/img/posts/unobtainium/kube-service-ac.png)
...
![](/assets/img/posts/unobtainium/secret-webapp-pod.png)
...
![](/assets/img/posts/unobtainium/kube-namespace.png)
...
![](/assets/img/posts/unobtainium/kube-get-perms.png)

```bash
kubectl get pods -n dev
```

![](/assets/img/posts/unobtainium/kube-dev-pods.png)
...
![](/assets/img/posts/unobtainium/pod-service.png)
...
![](/assets/img/posts/unobtainium/pod-app.png)
...
![](/assets/img/posts/unobtainium/pod-app-rev-shell.png)
...
![](/assets/img/posts/unobtainium/admin-token.png)
<!--
...
![](/assets/img/posts/unobtainium/admin-Privileges.png)
...
![](/assets/img/posts/unobtainium/edit-deployment.png)
...
![](/assets/img/posts/unobtainium/deployment-in-loop.png)
...
![](/assets/img/posts/unobtainium/rooted.png)
