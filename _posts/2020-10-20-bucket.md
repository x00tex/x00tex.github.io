...
- i read [API Docs](https://docs.aws.amazon.com/AmazonS3/latest/API/Welcome.html) and build my own [simple templates](https://github.com/x00tex/hackTheBox/tree/main/Boxes/linux/Retired/bucket/awsApiTmpl) .
